...
- Clone this repo:
```
git clone https://github.com/cloud318/deepak-clouds-mirror
cd mirrorbot
```
...
- **UPSTREAM_REPO**: Link for Bot Upstream Repo, if you want default update, fill ```https://github.com/cloud318/deepak-clouds-mirror```.
